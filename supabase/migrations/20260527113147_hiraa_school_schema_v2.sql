...
/*
  # Hiraa Moral School - Feature Tables (Part 2)

  Creates: live_classes, assignments, assignment_submissions, attendance,
           quizzes, quiz_questions, notes, messages, notifications, certificates
*/
