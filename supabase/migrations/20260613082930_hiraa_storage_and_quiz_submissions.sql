/*
  # Hiraa Moral School - Storage Buckets and Quiz Submissions
  
  Creates:
  - Storage buckets for file uploads
  - Storage policies for secure file access
  - quiz_submissions table for student quiz answers
  - quiz_attempts table to track quiz attempts
*/
...
-- Course materials and notes bucket
INSERT INTO storage.buckets (id, name, public, file_size_limit, allowed_mime_types)
VALUES (
  'course-materials',
  'course-materials',
...
-- Course materials: Teachers and admins can manage, students can read
...
-- Assignments: Students can upload, teachers can view/grade
...
-- Certificates: Public read, admins can manage
...
-- Track individual quiz question answers
